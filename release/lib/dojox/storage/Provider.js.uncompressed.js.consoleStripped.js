...
dojo.declare("dojox.storage.Provider", null, {
	...
	initialize: function(){
		...
		//		constructor.
		 0 && console.warn("dojox.storage.initialize not implemented");
	},
	...
	isAvailable: function(){ /*Boolean*/
		...
		//		platform.
		 0 && console.warn("dojox.storage.isAvailable not implemented");
	},
	...
	put: function(	/*string*/ key,
		...
		//		if left off, the value will be placed into dojox.storage.DEFAULT_NAMESPACE
		 ...
		 0 && console.warn("dojox.storage.put not implemented");
	},
	...
	get: function(/*string*/ key, /*string?*/ namespace){ /*Object*/
		...
		//		Any JavaScript object type; null if the key is not present
		 0 && console.warn("dojox.storage.get not implemented");
	},
	...
	getKeys: function(/*string?*/ namespace){ /*Array*/
		...
		//		Array of available keys
		 0 && console.warn("dojox.storage.getKeys not implemented");
	},
	...
	clear: function(/*string?*/ namespace){
		...
		//		namespace.
		 0 && console.warn("dojox.storage.clear not implemented");
	},
  
	remove: function(/*string*/ key, /*string?*/ namespace){
		// summary:
		//		Removes the given key from this storage system.
		 0 && console.warn("dojox.storage.remove not implemented");
	},
	
	getNamespaces: function(){ /*string[]*/
		 0 && console.warn("dojox.storage.getNamespaces not implemented");
	},
	...
	isPermanent: function(){ /*Boolean*/
		...
		//		when this platform is shutdown.
		 0 && console.warn("dojox.storage.isPermanent not implemented");
	},
	...
	getMaximumSize: function(){ /* mixed */
		...
		//		returned
		 0 && console.warn("dojox.storage.getMaximumSize not implemented");
	},
	...
	showSettingsUI: function(){
		...
		//		by calling hasSettingsUI(), it is shown.
		 0 && console.warn("dojox.storage.showSettingsUI not implemented");
	},

	hideSettingsUI: function(){
		// summary:
		//		If this provider has a settings UI, hides it.
		 0 && console.warn("dojox.storage.hideSettingsUI not implemented");
	},
