...
(function(
	...
	has.add = function(name, test, now, force){
	 ...
	 0 &&  0 && has.add("host-node", userConfig.has && "host-node" in userConfig.has ?
	...
	if( 0 ){
	 ...
	 0 &&  0 && has.add("host-rhino", userConfig.has && "host-rhino" in userConfig.has ?
	...
	if( 1 ){
		...
		if( 1  || has("host-webworker")){
			...
			// note: to get the file:// protocol to work in FF, you must set security.fileuri.strict_origin_policy to false in about:config
			 1 ||  1 || has.add("dojo-xhr-factory", 1);
	...
	var def = function(
		...
		if(targetModule && !waiting[targetModule.mid]){
			...
			// consequent to a require() or define("dojo/dojo.js.uncompressed", ) application; examples include defining modules on-the-fly
...
define(["../has", "./config", "require", "module"], function(has, config, require, module){
	...
	if( 0 ){
	 ...
	 1 ||  1 || has.add("dojo-guarantee-console",
...
define(["require", "module"], function(require, module){
	...
	if(! 1 ){
		...
		// can optimize these away iff desired
		 1 ||  1 || has.add("host-browser", isBrowser);
		 0 &&  0 && has.add("host-node", (typeof process == "object" && process.versions && process.versions.node && process.versions.v8));
		 0 &&  0 && has.add("host-rhino", (typeof load == "function" && (typeof Packages == "function" || typeof Packages == "object")));
		 1 ||  1 || has.add("dom", isBrowser);
		 1 ||  1 || has.add("dojo-dom-ready-api", 1);
		 1 ||  1 || has.add("dojo-sniff", 1);
	}
...
define(["./kernel", "../has", "require", "module", "../json", "./lang", "./array"], function(dojo, has, require, thisModule, json, lang, array) {
	...
	if (! 1 ){
	 ...
	 1 ||  1 || has.add("dojo-fast-sync-require", 1);
...
define([
	...
	// dojoConfig.require is deprecated; use the loader configuration property deps
	 1 ||  0 && has.add("dojo-config-require", 1);
	if( 1 ){
...
define(["./_base/kernel", "./has", "require", "./domReady", "./_base/lang"], function(dojo, has, require, domReady, lang){
	...
	var ready = dojo.ready = dojo.addOnLoad = function(priority, context, callback){
	 ...
	 1 ||  1 || has.add("dojo-config-addOnLoad", 1);
	if( 1 ){
